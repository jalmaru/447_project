...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2026 at 09:06 PM
...
('root', '[{\"db\":\"school_project\",\"table\":\"users\"},{\"db\":\"school_project\",\"table\":\"teams\"}]');
...
('root', '2026-04-26 19:06:35', '{\"Console\\/Mode\":\"collapse\"}');
...
--
CREATE DATABASE IF NOT EXISTS `school_project` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `school_project`;
